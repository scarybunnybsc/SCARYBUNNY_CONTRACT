...
contract ScaryBunny is BEP20, Ownable {
    ...
    address public marketingWallet = 0x467E6884301b160F03CC64F0Df55ddAfECC1DE94;
    address public stakingWallet = 0x95EcE20726cB040C6cE3994caD83933652D1C8D6;
    address public rabbitWallet = 0x467E6884301b160F03CC64F0Df55ddAfECC1DE94;
    ...
    constructor() BEP20("Scary Bunny", "SB") {
        ...
        lockTheSwap
    {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 rabbitAmt = unitBalance * 2 * swapTaxes.rabbit;
            if (rabbitAmt > 0) {
                payable(rabbitWallet).sendValue(rabbitAmt);
            }
        }
    }
    ...
    function updateRabbitWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0), "Fee Address cannot be zero address");
        rabbitWallet = newWallet;
    }
